...
`tools/diagnostics/GradientCoupledInstanton/spectrum.py`. See
`.claude/rules/test-selection.md` for the full decision rule and the current
list of `slow`-marked files.
